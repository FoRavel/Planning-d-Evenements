 ...
 * @author Fanilo
 */
public class TEST_JFPage1 extends javax.swing.JFrame {

    /**
     * Creates new form TEST_JFPage1
     */
    public TEST_JFPage1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jBSuivant.setText("Page Suivante");
    ...
    private void jBSuivantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSuivantActionPerformed
        TEST_JFPage2 jf = new TEST_JFPage2(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TEST_JFPage1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TEST_JFPage1 jf = new TEST_JFPage1();
                jf.setLocationRelativeTo(null);
                jf.setVisible(true);
            }
        });
